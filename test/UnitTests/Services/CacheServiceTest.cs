			...
			switch (type)
			{
				...
				case Metrics.Ping:
					...
					await context.PingDataPoints.AddRangeAsync(
						...
						{
							HttpStatusCode = HttpStatusCode.ServiceUnavailable.AsInt(),
							ResponseTime = new TimeSpan(0, 0, 0, 0, 5000),
							Metric = metric
						},
						new PingDataPoint
						{
						...
						{
							HttpStatusCode = HttpStatusCode.OK.AsInt(),
							ResponseTime = new TimeSpan(0, 0, 0, 0, 950),
							Metric = metric
						},
						new PingDataPoint
						{
							HttpStatusCode = HttpStatusCode.OK.AsInt(),
							ResponseTime = new TimeSpan(0, 0, 0, 0, 940),
							Metric = metric
						},
						new PingDataPoint
						{
							HttpStatusCode = HttpStatusCode.OK.AsInt(),
							ResponseTime = new TimeSpan(0, 0, 0, 0, 934),
							Metric = metric
						},
						new PingDataPoint
						{
			...
			switch (type)
			{
				...
				case Metrics.Ping:
					...
					await context.PingDataPoints.AddRangeAsync(
						...
						{
							HttpStatusCode = HttpStatusCode.ServiceUnavailable.AsInt(),
							ResponseTime = new TimeSpan(0, 0, 0, 0, 0),
							Metric = metric
						},
						new PingDataPoint
						{
